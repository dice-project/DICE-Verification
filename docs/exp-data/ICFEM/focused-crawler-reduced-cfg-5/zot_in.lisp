...
;	(defconstant AVG_EMIT_RATE_S2 0.2)
  	...
  	(defconstant AVG_EMIT_RATE_wpSpout 1.5)
...
;;	BOLTS MAX TAKE RATES, SIGMA AND D
    ...
    (defconstant MAX_PROC_RATE_articleExtraction (/ C_TAKE_articleExtraction 0.1))
    ...
    (defconstant ALPHA_articleExtraction 0.1)
    ...
    (defconstant MAX_PROC_RATE_mediaExtraction (/ C_TAKE_mediaExtraction 0.1))
    ...
    (defconstant ALPHA_mediaExtraction 0.1)
