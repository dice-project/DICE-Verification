...
;	(defconstant AVG_EMIT_RATE_S2 0.2)
  	...
  	(defconstant AVG_EMIT_RATE_wpSpout 2.0)
...
;;	BOLTS MAX TAKE RATES, SIGMA AND D
    ...
    (defconstant MAX_PROC_RATE_expander (/ C_TAKE_expander 0.3))
    ...
    (defconstant ALPHA_expander 0.3)



    (defconstant C_TAKE_articleExtraction 2)


    (defconstant MAX_PROC_RATE_articleExtraction (/ C_TAKE_articleExtraction 0.2))
    ...
    (defconstant ALPHA_articleExtraction 0.2)



    (defconstant C_TAKE_mediaExtraction 2)


    (defconstant MAX_PROC_RATE_mediaExtraction (/ C_TAKE_mediaExtraction 0.2))
    ...
    (defconstant ALPHA_mediaExtraction 0.2)
