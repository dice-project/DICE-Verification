package it.polimi.dice.verification.ui.launcher.common;

import org.eclipse.osgi.util.NLS;

public class Messages extends NLS {
	private static final String BUNDLE_NAME = "it.polimi.dice.verification.ui.launcher.common.messages"; //$NON-NLS-1$
