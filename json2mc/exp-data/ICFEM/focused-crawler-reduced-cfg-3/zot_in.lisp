...
;;	BOLTS MAX TAKE RATES, SIGMA AND D
    ...
    (defconstant MAX_PROC_RATE_WpDeserializer (/ C_TAKE_WpDeserializer 0.3))
    ...
    (defconstant ALPHA_WpDeserializer 0.3)



    (defconstant C_TAKE_expander 12)


    (defconstant MAX_PROC_RATE_expander (/ C_TAKE_expander 0.75))
    ...
    (defconstant ALPHA_expander 0.75)
    ...
    (defconstant MAX_PROC_RATE_articleExtraction (/ C_TAKE_articleExtraction 0.5))
    ...
    (defconstant ALPHA_articleExtraction 0.5)
    ...
    (defconstant MAX_PROC_RATE_mediaExtraction (/ C_TAKE_mediaExtraction 0.5))
    ...
    (defconstant ALPHA_mediaExtraction 0.5)
...
;	(setf (gethash 'mediaExtraction the-proc-time-table-2) (getTimeIntervals C_TAKE_mediaExtraction ALPHA_mediaExtraction)) ;OLDversion
 ...
 ;TODO risistemare
	(setf (gethash 'wpSpout the-rate-threshold-table) (getRateIntervals 5))
	;(setf (gethash 'wpSpout the-proc-time-table) (getTimeIntervals 5 ALPHA_wpSpout))
    (setf (gethash 'wpSpout the-proc-time-table) (getIntervals 5 ALPHA_wpSpout (/ ALPHA_wpSpout 10.0)))
